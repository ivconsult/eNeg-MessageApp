...
MessageApp supports the user by suggesting message templates in certain negotiation phases (Preparation, Introduction, Agenda Setting, Negotiation und Closing) and certain message types (Question, Answer, Offer und Comment) as well as in creating message templates

MessageApp is a silverlight web based platform with desktop add-on extension, MVVM framework applied with n-tier layers.
...
Negotiation require a lot of effort and concentration and sometimes the user need to send the same message schema among all counterparts as a formal offer, quote or request for 

information to deliver certain messages in a professional way. MessageApp provides the following services to the user:

* Set of pre-defined template message that the user can send or edit for his certain needs
* User can define different phases of the negotiation (e.g. preparation, discussion, closing, etc.)
* User can define different types of messages across all negotiation phases (e.g. greetings, offerings, etc.)
* User can manage his template messages
