...
namespace citPOINT.MessageApp.Client
{
    ...
    public partial class PopUpWindow : RadWindow,ICleanup
    {
        ...
        public IMessageTemplateModel ViewModel
        {
            get
            {
                return (DataContext as IMessageTemplateModel);
            }
        }
        ...
        public PopUpWindow(string header)
        {
            ...
            MessageAppMessanger.ChangeScreenMessage.Register(this, onFlippingByPageName);
        }
        #endregion
        ...
        {
            if (PageName == MessageAppViewTypes.ClosePopupView)
            {
                mIsExit = false;
                this.Close();
            }
