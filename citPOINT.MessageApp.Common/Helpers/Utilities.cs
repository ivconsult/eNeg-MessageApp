...
namespace citPOINT.MessageApp.Common
{
    ...
    /// </summary>
    public class MessageAppConfigurations
    {
        #region → Properties     .
        ...
        public static string AppName { get { return "Message App"; } }
        ...
        public static Uri MainServiceUri
        {
            get
            {
                if (MessageAppConfigurations.MainPlatformInfo != null)
                {

                    var app = MessageAppConfigurations
                                    .MainPlatformInfo
                                    .GetApplicationInfo(MessageAppConfigurations.AppName);
